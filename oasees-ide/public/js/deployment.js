...
class DAODeployer {
    constructor() {
        ...
        this.marketplace_address = "0x5FbDB2315678afecb367f032d93F642f64180aa3"
        this.nft_address = "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512"
    ...
    async registerDAO(governance, timelock, token, box) {
        const web3 = new Web3(window.ethereum)
        const blockscout_api = "http://10.160.3.172:8082/api/v2"
        try {
            const response = await fetch(`${blockscout_api}/smart-contracts/${this.marketplace_address}`);
            ...
            const data = await response.json();
            const marketplace = new web3.eth.Contract(data.abi, this.marketplace_address);
            const tx = marketplace.methods.makeDao(governance,timelock,token,box,"testing")
    ...
    async deployDAO(e) {
        ...
        try {
            ...
            if(result.success){
                ...
                await this.registerDAO(governance,timelock,votetoken,box);
